...
#for t in 1:1
    ...
    for line_id in df_ptdf[df_ptdf.DateTime .== timestamp, :line_id]
        l = df_line_edge_map[df_line_edge_map.line_id .== line_id, :edge][1] + 1
...
XLSX.writetable("./flow_based_domain/ptdf_z_calc_nuts_feb_tso.xlsx", "Sheet1" => df_ptdf_calc)